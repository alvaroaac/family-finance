# Prompt para Claude design — UI "Editorial acolhedor" do Family Finance

> Cole o texto abaixo da linha no Claude design. Ele é autocontido — não depende de
> acesso ao repositório. Anexe junto, se possível, um screenshot da landing do chá de
> casa nova (referência de vibe) e um do dashboard atual (referência do que substituir).
