-- 0017_obligation_actual_amount.sql
-- Keep an obligation's configured amount as its forecast while allowing the
-- materialized monthly payment transaction to record the actual amount.
...
begin
  ...
  insert into transactions (
    ...
    obligation.subcategory_id, obligation.account_id, null,
